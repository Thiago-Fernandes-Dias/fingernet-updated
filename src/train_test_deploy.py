...
from scipy import io, misc, ndimage, signal, sparse
...
parser.add_argument(
    "mode", type=str, default="train", help="train-test, test or deploy"
)
...
deploy_sets = [
    ("/Datasets/FVC/FVC2000/Dbs/Db1_a/bmp/", "FVC2000_DB1_A"),
    ("/Datasets/FVC/FVC2000/Dbs/Db1_b/bmp/", "FVC2000_DB1_B"),
    ("/Datasets/FVC/FVC2000/Dbs/Db2_a/bmp/", "FVC2000_DB2_A"),
    ("/Datasets/FVC/FVC2000/Dbs/Db2_b/bmp/", "FVC2000_DB2_B"),
    ("/Datasets/FVC/FVC2000/Dbs/Db3_a/bmp/", "FVC2000_DB3_A"),
    ("/Datasets/FVC/FVC2000/Dbs/Db3_b/bmp/", "FVC2000_DB3_B"),
    ("/Datasets/FVC/FVC2000/Dbs/Db4_a/bmp/", "FVC2000_DB4_A"),
    ("/Datasets/FVC/FVC2000/Dbs/Db4_b/bmp/", "FVC2000_DB4_B"),
    ("/Datasets/FVC/FVC2002/Dbs/Db1_a/bmp/", "FVC2002_DB1_A"),
    ("/Datasets/FVC/FVC2002/Dbs/Db1_b/bmp/", "FVC2002_DB1_B"),
    ("/Datasets/FVC/FVC2002/Dbs/Db2_a/bmp/", "FVC2002_DB2_A"),
    ("/Datasets/FVC/FVC2002/Dbs/Db2_b/bmp/", "FVC2002_DB2_B"),
    ("/Datasets/FVC/FVC2002/Dbs/Db3_a/bmp/", "FVC2002_DB3_A"),
    ("/Datasets/FVC/FVC2002/Dbs/Db3_b/bmp/", "FVC2002_DB3_B"),
    ("/Datasets/FVC/FVC2002/Dbs/Db4_a/bmp/", "FVC2002_DB4_A"),
    ("/Datasets/FVC/FVC2002/Dbs/Db4_b/bmp/", "FVC2002_DB4_B"),
    ("/Datasets/FVC/FVC2004/Dbs/DB1_A/bmp/", "FVC2004_DB1_A"),
    ("/Datasets/FVC/FVC2004/Dbs/DB1_B/bmp/", "FVC2004_DB1_B"),
    ("/Datasets/FVC/FVC2004/Dbs/DB2_A/bmp/", "FVC2004_DB2_A"),
    ("/Datasets/FVC/FVC2004/Dbs/DB2_B/bmp/", "FVC2004_DB2_B"),
    ("/Datasets/FVC/FVC2004/Dbs/DB3_A/bmp/", "FVC2004_DB3_A"),
    ("/Datasets/FVC/FVC2004/Dbs/DB3_B/bmp/", "FVC2004_DB3_B"),
    ("/Datasets/FVC/FVC2004/Dbs/DB4_A/bmp/", "FVC2004_DB4_A"),
    ("/Datasets/FVC/FVC2004/Dbs/DB4_B/bmp/", "FVC2004_DB4_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2000_DB1_A/bmp/", "FVC2000_PRIORENH_DB1_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2000_DB1_B/bmp/", "FVC2000_PRIORENH_DB1_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2000_DB2_A/bmp/", "FVC2000_PRIORENH_DB2_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2000_DB2_B/bmp/", "FVC2000_PRIORENH_DB2_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2000_DB3_A/bmp/", "FVC2000_PRIORENH_DB3_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2000_DB3_B/bmp/", "FVC2000_PRIORENH_DB3_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2000_DB4_A/bmp/", "FVC2000_PRIORENH_DB4_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2000_DB4_B/bmp/", "FVC2000_PRIORENH_DB4_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2002_DB1_A/bmp/", "FVC2002_PRIORENH_DB1_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2002_DB1_B/bmp/", "FVC2002_PRIORENH_DB1_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2002_DB2_A/bmp/", "FVC2002_PRIORENH_DB2_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2002_DB2_B/bmp/", "FVC2002_PRIORENH_DB2_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2002_DB3_A/bmp/", "FVC2002_PRIORENH_DB3_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2002_DB3_B/bmp/", "FVC2002_PRIORENH_DB3_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2002_DB4_A/bmp/", "FVC2002_PRIORENH_DB4_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2002_DB4_B/bmp/", "FVC2002_PRIORENH_DB4_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2004_DB1_A/bmp/", "FVC2004_PRIORENH_DB1_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2004_DB1_B/bmp/", "FVC2004_PRIORENH_DB1_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2004_DB2_A/bmp/", "FVC2004_PRIORENH_DB2_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2004_DB2_B/bmp/", "FVC2004_PRIORENH_DB2_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2004_DB3_A/bmp/", "FVC2004_PRIORENH_DB3_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2004_DB3_B/bmp/", "FVC2004_PRIORENH_DB3_B"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2004_DB4_A/bmp/", "FVC2004_PRIORENH_DB4_A"),
    ("/Datasets/FVC_FLARE_ENH/priorenh/FVC2004_DB4_B/bmp/", "FVC2004_PRIORENH_DB4_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2000_DB1_A/bmp/", "FVC2000_UNETENH_DB1_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2000_DB1_B/bmp/", "FVC2000_UNETENH_DB1_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2000_DB2_A/bmp/", "FVC2000_UNETENH_DB2_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2000_DB2_B/bmp/", "FVC2000_UNETENH_DB2_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2000_DB3_A/bmp/", "FVC2000_UNETENH_DB3_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2000_DB3_B/bmp/", "FVC2000_UNETENH_DB3_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2000_DB4_A/bmp/", "FVC2000_UNETENH_DB4_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2000_DB4_B/bmp/", "FVC2000_UNETENH_DB4_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2002_DB1_A/bmp/", "FVC2002_UNETENH_DB1_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2002_DB1_B/bmp/", "FVC2002_UNETENH_DB1_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2002_DB2_A/bmp/", "FVC2002_UNETENH_DB2_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2002_DB2_B/bmp/", "FVC2002_UNETENH_DB2_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2002_DB3_A/bmp/", "FVC2002_UNETENH_DB3_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2002_DB3_B/bmp/", "FVC2002_UNETENH_DB3_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2002_DB4_A/bmp/", "FVC2002_UNETENH_DB4_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2002_DB4_B/bmp/", "FVC2002_UNETENH_DB4_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2004_DB1_A/bmp/", "FVC2004_UNETENH_DB1_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2004_DB1_B/bmp/", "FVC2004_UNETENH_DB1_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2004_DB2_A/bmp/", "FVC2004_UNETENH_DB2_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2004_DB2_B/bmp/", "FVC2004_UNETENH_DB2_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2004_DB3_A/bmp/", "FVC2004_UNETENH_DB3_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2004_DB3_B/bmp/", "FVC2004_UNETENH_DB3_B"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2004_DB4_A/bmp/", "FVC2004_UNETENH_DB4_A"),
    ("/Datasets/FVC_FLARE_ENH/unetenh/FVC2004_DB4_B/bmp/", "FVC2004_UNETENH_DB4_B"),
    ("/Datasets/CrossMatch_Sample_DB/bmp/", "CrossMatch_Sample_DB"),
    ("/Datasets/CrossMatch_FLARE_ENH/priorenh/bmp", "CrossMatch_PRIORENH"),
    ("/Datasets/CrossMatch_FLARE_ENH/unetenh/bmp", "CrossMatch_UNETENH"),
    ("/Datasets/UareU_sample_DB/bmp/", "UareU_sample_DB"),
    ("/Datasets/UareU_sample_DB_FLARE_ENH/priorenh/bmp", "UareU_sample_DB_PRIORENH"),
    ("/Datasets/UareU_sample_DB_FLARE_ENH/unetenh/bmp", "UareU_sample_DB_UNETENH"),
...
def get_maximum_img_size_and_names(dataset, sample_rate=None):
    ...
    for folder, rate in zip(dataset, sample_rate):
        ...
        img_size.append(
            np.array(
                misc.imread(folder + "images/" + img_name_t[0] + ".bmp", mode="L").shape
            )
        )
...
def ori_loss(y_true, y_pred, lamb=1.0):
    # clip
    ...
    lamb_pos, lamb_neg = 1.0, 1.0
    logloss = lamb_pos * y_true * K.log(y_pred) + lamb_neg * (1 - y_true) * K.log(
        1 - y_pred
    )
    ...
    coherence = K.sqrt(K.square(sin2angle) + K.square(cos2angle)) / (
        modulus + K.epsilon()
    )
...
def seg_loss(y_true, y_pred, lamb=1.0):
    # clip
    y_pred = K.tf.clip_by_value(y_pred, K.epsilon(), 1 - K.epsilon())
    # weighted cross entropy loss
    ...
    # smooth loss
    smooth_kernal = np.reshape(
        np.array([[-1, -1, -1], [-1, 8, -1], [-1, -1, -1]], dtype=np.float32) / 8,
        [3, 3, 1, 1],
    )
...
def mnt_s_loss(y_true, y_pred):
    ...
    y_true = K.tf.where(
        K.tf.less(y_true, 0.0), K.tf.zeros_like(y_true), y_true
    )  # set -1 -> 0
    # weighted cross entropy loss
    total_elements = K.sum(label_seg) + K.epsilon()
    lamb_pos, lamb_neg = 10.0, 0.5
    logloss = lamb_pos * y_true * K.log(y_pred) + lamb_neg * (1 - y_true) * K.log(
        1 - y_pred
    )
    # apply ROI
            ...
            if i % (20 / batch_size) == 0:
                ...
                logging.info(
                    ...
                    " ".join(
                        [
                            "%s:%.4f\n" % (x)
                            for x in zip(main_net_model.metrics_names, loss)
                        ]
                    ),
                )
...
def test(test_set, model, outdir, test_num=10, draw=True):
    ...
    main_net_model.compile(
        ...
        metrics={
            "ori_out_1": [ori_acc_delta_10, ori_acc_delta_20],
    ...
    for j, test in enumerate(
        ...
        if j < test_num:
            ...
            (
                ...
                mnt_h_out,
                mnt_s_out,
            ) = main_net_model.predict(test[0])
            metrics = main_net_model.train_on_batch(
                test[0],
                {
                    "ori_out_1": test[1],
                    "ori_out_2": test[2],
            ...
            logging.info(
                ...
                " ".join(
                    [
                        "%s:%.4f\n" % (x)
                        for x in zip(main_net_model.metrics_names, metrics)
                    ]
                ),
            )
            ...
            if draw:
                ...
                angval = (np.argmax(angval, axis=-1) * 2 - 90) / 180.0 * np.pi
                draw_ori_on_img(
                    test[0], angval, seg_out, "%s%s_ori.png" % (outdir, test[8][0])
                )
                draw_minutiae(
                    test[0], mnt_nms[:, :3], "%s%s_mnt.png" % (outdir, test[8][0])
                )
                draw_minutiae(
                    test[0], mnt_gt[:, :3], "%s%s_mnt_gt.png" % (outdir, test[8][0])
                )
        else:
            break
...
def deploy(deploy_set, set_name=None):
    ...
    seg_dir = os.path.join(output_dir, set_name, "seg")
    xyt_dir = os.path.join(output_dir, set_name, "xyt")
    ist_dir = os.path.join(output_dir, set_name, "ist")
    mnt_dir = os.path.join(output_dir, set_name, "mnt_highlights")
    ori_image_dir = os.path.join(output_dir, set_name, "ori_images")
    ori_maps_dir = os.path.join(output_dir, set_name, "ori_maps")
    ori_enh_dir = os.path.join(output_dir, set_name, "ori_enh")
    mkdir(seg_dir)
    mkdir(ori_image_dir)
    mkdir(ori_maps_dir)
    mkdir(ori_enh_dir)
    ...
    for i in xrange(0, len(img_name)):
        ...
        ori = (np.argmax(ori, axis=-1) * 2 - 90) / 180.0 * np.pi
        time_afterpost = time()
        mnt_writer_xyt(mnt_nms, os.path.join(xyt_dir, "%s.xyt" % (img_name[i])))
        mnt_writer_iso(
            mnt_nms,
            os.path.join(ist_dir, "%s.ist" % (img_name[i])),
        ...
        draw_ori_on_img(
            image,
            ori,
            np.ones_like(seg_out),
            os.path.join(ori_image_dir, "%s.png" % (img_name[i])),
        )
        draw_minutiae(
            image, mnt_nms[:, :3], os.path.join(mnt_dir, "%s.png" % (img_name[i]))
        )
        misc.imsave(
            os.path.join(ori_enh_dir, "%s.png" % (img_name[i])),
            np.squeeze(enhance_img)
            * ndimage.zoom(np.round(np.squeeze(seg_out)), [8, 8], order=0),
        )
        misc.imsave(
            os.path.join(seg_dir, "%s.png" % (img_name[i])),
            ndimage.zoom(np.round(np.squeeze(seg_out)), [8, 8], order=0),
        )
        io.savemat(
            os.path.join(ori_maps_dir, "%s.mat" % (img_name[i])),
